...
class App extends Component {
  ...
  renderSwitch = (state) => {
    switch (state) {
      case "Stripes":
        return <Stripes updateCSS={this.updateCSS} />;
      case "ZigZag":
        return <ZigZag updateCSS={this.updateCSS} />;
      case "PolkaDots":
        return <PolkaDots updateCSS={this.updateCSS} />;
      case "Gingham":
        return <Gingham updateCSS={this.updateCSS} />;
      default:
        return null;
    }
  };
        ...
        <Container>
          <Main>
            <Heading>
              <h1>Patternss</h1>
              <p>
                Generate CSS code for background patterns while live previewing
              </p>
            </Heading>
            <Choose>
            ...
            <Footer>
              Made by{" "}
              <a
                href="https://twitter.com/keveightysev"
                target="_blank"
              ...
              -{" "}
              <a
                href="https://github.com/keveightysev/patternss"
                target="_blank"
                rel="noopener noreferrer"
              >
                Git Repo
